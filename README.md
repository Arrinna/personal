...
Прошла переобучение по программе, включающей в себя темы: SQL, Python (включая библиотеки для анализа и ML), BI-инструменты, бизнес-аналитику и продуктовую аналитику. 
